...
resource "aws_s3_bucket_website_configuration" "website" {
  ...
  index_document {
    suffix = "moon-lander.html"
  }

  error_document {
    key = "moon-lander.html"
  }
}
...
# Block public access to S3 bucket (CloudFront will handle access)
...
# Remove the problematic aws_s3_object resource - we'll use GitHub Actions for file uploads instead
# The S3 bucket will be populated by the CI/CD pipeline
...
resource "aws_cloudfront_distribution" "website" {
  ...
  default_root_object = "moon-lander.html"
  ...
  custom_error_response {
    error_code         = 404
    response_code      = 200
    response_page_path = "/moon-lander.html"
  }
